...
### Diabetes
# 1324-1327 : 2443-X.0; Instances: [0,3] (Diabetes diagnosed by doctor)
...
cat /lustre03/project/6008063/neurohub/UKB/Tabular/current.csv | csvcut -c 1,27,28,97,479,941,949,957,1045,965-968,7008,10795,12128,12132,19789,479,19802,19968,19970,19972,19801,19799,19798\
...
cat /lustre03/project/6008063/neurohub/UKB/Tabular/current.csv | head -1000 | csvcut -c 1,27,28,97,941,949,957,1045,965-968,7008,10795,12128,12132,19789,479,19802,19968,19970,19972,19801,19799,19798\
1324-1327 > /home/yalap95/current_df/current_subset.csv
...
#*** see "merge_ukbb_data.py" file in AccelerometerProcessing GitHub Repo
