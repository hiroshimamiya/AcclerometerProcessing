...
>>>>>>> e51fb10b2853572c662214d152ca7c95026c2192
)
...
# Education
full_df$age_education <- full_df$age_education_numeric_raw 
full_df$age_education[grepl("College or University degree", full_df$qualif_raw)] <- 21
# check there are no values below 0, which shouldn't be possible:
print(nrow(full_df[!is.na(full_df$age_education) & full_df$age_education < 0, ]))
# recode any values above 21 as 21 (for consistency with imputation):
full_df$age_education[full_df$age_education > 21] <- 21 
