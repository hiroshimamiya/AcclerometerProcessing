...
## we replace "Do not know"s and "Prefer not to say"s by NAs:
full_df <- full_df %>%
...
full_df$raw_meat_raw <- full_df$raw_meat 
full_df <- full_df %>%
  mutate(raw_meat = recode(as.character(raw_meat), !!!red_meat_coding))
