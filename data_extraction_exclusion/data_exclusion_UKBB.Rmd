...
full_df <- full_df %>%
  mutate(processed_meat_0 = case_when(
    processed_meat_0 < 2 ~ "< 2 servings/week",
    processed_meat_0 >= 2 & processed_meat_0 < 4 ~ "2 to 4 servings/week",
    processed_meat_0 > 4  ~ "More than 4 servings/week",
    TRUE ~ NA_character_  
  ))
...
full_df <- full_df %>%
  mutate(oily_fish = case_when(
    oily_fish < 2 ~ "< 2 servings/week",
    oily_fish >= 2 & oily_fish < 4 ~ "2 to 4 servings/week",
    oily_fish > 4  ~ "More than 4 servings/week",
    TRUE ~ NA_character_  
  ))
