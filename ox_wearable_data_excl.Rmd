...
---
##### Yacine Note: This code will only work in beluga server
...
dat <- read.csv("/home/yalap95/current_df/final_df.csv") data.table package for fast reading of large data
...
cols_dat <- c("eid", "sex", "year_birth", "month_birth", "ethnicity_raw",
              ...
              "overall_activity","fresh_fruit","cooked_vg","oily_fish", colnames(dat)[grepl("acceleration", colnames(dat))]) 
# Yacine Note: added the diet columns 
cols_dat_hes <- c("eid","stroke_date", "stroke_source", "ischaemic_stroke_date", "ischaemic_stroke_source", "intracerebral_haemorrhage_date", "intracerebral_haemorrhage_source", "subarachnoid_haemorrhage_date",  "subarachnoid_haemorrhage_source","myocardial_infarction_date", "myocardial_infarction_source", "STEMI_date", "STEMI_source", "NSTEMI_date","NSTEMI_source")
# Yacine Note: replaced with the stokes and MI columns we extracted
