...
coefDf <- data.frame(do.call(cbind, coefs)) %>% purrr::set_names(paste(c(1:6), "Model")) # Covariates are misalighed due to different number of spline knots 
...
```{r}
png("combined_main_scaled.png", width = 2250, height = 2625, res = 300)
...
par(mfrow=c(4,2))
hist(dt$mvpa1, main = "Dt, MVPA1"); hist(dt2$mvpa1, main = "Dt2, MVPA1"); 
hist(dt$mvpa2, main = "Dt, MVPA2"); hist(dt2$mvpa2, main = "Dt2, MVPA2"); 
hist(dt$mvpa3, main = "Dt, MVPA3"); hist(dt2$mvpa3, main = "Dt2, MVPA3"); 
hist(dt2$mvpa4, main = "Dt2, MVPA4")
dev.off()
