...
dt3 <- readRDS("/home/yacine/AcclerometerProcessing/prepped_dt3.rds")
```
...
#### Combined Plots
```{r}
png("combined_main.png", width = 1600, height = 1200)
...
#### Combined Plots
```{r}
png("combined_sa1.png", width = 1600, height = 1200)
...
#### Combined Plots
```{r}
png("combined_sa2.png", width = 1600, height = 1200)
par(mfrow = c(3, 2), oma = c(0, 0, 2, 0)) 
# PA1
## Stroke
plotHR(fit_pa1_stroke_sa2,
...
Female
```{r}
png("combined_PA1_sa3.png", width = 1600, height = 1200)
...
png("combined_PA2_sa3.png", width = 1600, height = 1200)
par(mfrow = c(2, 2), oma = c(0, 0, 2, 0)) 
# PA2
## Stroke - Female
...
png("combined_PA3_sa3.png", width = 1600, height = 1200)
par(mfrow = c(2, 2), oma = c(0, 0, 2, 0)) 
# PA3
## Stroke - Female
...
Male
```{r}
png("combined_PA1_sa3_m.png", width = 1600, height = 1200)
...
png("combined_PA2_sa3_m.png", width = 1600, height = 1200)
par(mfrow = c(1, 2), oma = c(0, 0, 2, 0)) 
# PA2
plotHR(fit_pa2_stroke_sa3_m,
       term = 1,
...
mtext("Sensitivity Analysis 3 - Male: Machine Learning", side = 3, outer = TRUE, line = 0, cex = 1.5, font = 2)
dev.off()




png("combined_PA3_sa3_m.png", width = 1600, height = 1200)
par(mfrow = c(1, 2), oma = c(0, 0, 2, 0)) 
# PA3
## Stroke
plotHR(fit_pa3_stroke_sa3_m,
...
mtext("Sensitivity Analaysis 3 - Male: Activity Count", side = 3, outer = TRUE, line = 0, cex = 1.5, font = 2)
dev.off()
...
#### Combined Plots
```{r}
png("combined_sa4.png", width = 1600, height = 1200)
par(mfrow = c(3, 2), oma = c(0, 0, 2, 0)) 
# PA1
## Stroke
plotHR(fit_pa1_stroke_sa4,
...
#### Combined Plots
```{r}
png("combined_PA1_sa6.png", width = 1600, height = 1200)
par(mfrow = c(3, 2), oma = c(0, 0, 2, 0)) 
# PA1
## Stroke
