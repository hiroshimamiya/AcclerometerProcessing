...
```
## Table 2 - subanalaysis (incudes PA4, diabetes and depression)
```{r}
...
# Save 
flextable::save_as_docx("Distribution of participant characteristics by Quartile of Moderate Vigorous Physical Activity" = tb2,  
               path = "testTable.docx", 
               pr_section = sect_properties
)
...
saveRDS(dt3, "/home/yacine/AcclerometerProcessing/prepped_dt3.rds")
