...
enmoTSParallel_PA1$MVPA_100 <- enmoTSParallel_PA1$MVPA2_total_PA1* 7*24*60
enmoTSParallel_PA1$MVPA_150 <- enmoTSParallel_PA1$MVPA3_total_PA1* 7*24*60
...
full_df_PA <- inner_join(
  full_df, 
  enmoTSParallel_PA1 %>% 
    dplyr::select(eid, MVPA_min_PA1, LPA_min_PA1, SB_min_PA1, MVPA_100, MVPA_150),
  by = "eid")
...
full_df_PA_2 <- full_df_PA_2 %>%  filter(MVPA_min_PA4 < 2500)
dim(full_df_PA_2)
