...
# Remove unknowns from greenspace and bluespace variables
dt <- dt %>%
  mutate(across(
    c(water_300m, greenspace_300m, naturalenv_300m),
    ~ ifelse(. == "Unknown" | . %in% c(9999, 9998), NA, .) 
  )) %>%
  drop_na(water_300m, greenspace_300m, naturalenv_300m)
