...
legend("topright", c("Q1", "Q2", "Q3", "Q4"), col = c("black", "grey", "blue", "red"))
...
plot(kmfit2_stoke, col = c("black", "grey", "blue", "red"), xlab = "Survival time per month", ylab = "Survival Probabilities", ylim = c(1.0, 0.95))
legend("topright", c("Q1", "Q2", "Q3", "Q4"), col = c("black", "grey", "blue", "red"))
...
par(mfrow = c(2, 2), oma = c(4, 4, 2, 1), mar = c(3, 3, 2, 2)) # Adjust 'oma' to add space for labels
...
# ML Stroke
plot(kmfit2_stoke, col = c("black", "grey", "blue", "red"), 
     ylim = c(1.0, 0.95))
...
legend("bottomleft", legend = c("Q1", "Q2", "Q3", "Q4"), 
       col = c("black", "grey", "blue", "red"), lty = 1, cex = 0.8) # legend
mtext("Survival time per month", side = 1, outer = TRUE, line = 2.5) # y-axis title
mtext("Survival Probabilities", side = 2, outer = TRUE, line = 2.5) # x-axis title
```
