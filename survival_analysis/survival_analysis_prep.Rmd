...
full_df_incl_PA1_PA2 <- full_df_incl_PA1_PA2 %>%
  mutate(sex = recode(sex, `0` = "Man", `1` = "Woman"),
         stroke = recode(stroke, `0` = "Never had recorded stroke", "1" = "Recorded having a stroke"),
         MI = recode(MI, `0` = "Never had recorded MI", "1" = "Recorded having a MI"))
