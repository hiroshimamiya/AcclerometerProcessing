...
## We load the data:
```{r}
dt <- read.csv("/home/yacine/UKBB_beluga/prepped_dt.csv", check.names = FALSE) # full df with exclusions + recoding and all data prepared for survival analysis
```
...
# Save 
flextable::save_as_docx("Hazard ratios for icidence MI" = tb3,  
...
# Save 
flextable::save_as_docx("Hazard ratios for incidence stroke: 2 years stroke survival" = t3,  
...
# Save 
flextable::save_as_docx("Hazard ratios for incidence MI: 2 years MI survival" = t3,  
