...
# Model for PA 3
fit3 <- coxph(as.formula(paste(f_stroke, " ~" ,  "MVPA_Quant_PA3_trucated + ",  f_cov)), data = dt)
t3<- tbl_regression(fit3, exponentiate = TRUE,  
                    label = list("MVPA_Quant_PA3_trucated" = "MVPA Quartile"), 
                    include = "MVPA_Quant_PA3_trucated"
                    )  
...
fit3 <- coxph(as.formula(paste(f_MI, " ~" ,  "MVPA_Quant_PA3_trucated + ",  f_cov)), data = dt)
t3<- tbl_regression(fit3, exponentiate = TRUE,  
                    label = list("MVPA_Quant_PA3_trucated" = "MVPA Quartile"), 
                    include = "MVPA_Quant_PA3_trucated"
                    )  
...
t1<- tbl_regression(fit1, exponentiate = TRUE, 
                    label = list("MVPA_Quant_PA1_trucated" = "MVPA Quartile_trucated"), 
                    include = "MVPA_Quant_PA1_trucated"
                    ) 
